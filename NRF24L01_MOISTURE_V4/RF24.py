...
masterAddress = [0xE0,0xE0,0xE0,0xE0,0xE0]
...
device = [
	  RF_Device([ 0xA5,0xA5,0xA5,0xA5,0x01],30,clockFrequency=800000),
	  RF_Device([ 0xA5,0xA5,0xA5,0xA5,0x02],30,clockFrequency=800000),
	  RF_Device([ 0xA5,0xA5,0xA5,0xA5,0x03],30,clockFrequency=800000)
         ]
