...
unsigned long moistureFrequency;
...
bool readSensor()
{
  ...
  moistureFrequency = FreqCount.read();
  ...
  Serial.println(moistureFrequency);
#endif
...
//    delay(20);
  ...
  if (cycle == ModeReadSensor)
  {
    ...
    if (readSensor())
    {
      ...
      Txmdata.frequency = moistureFrequency * 10;  // freq= count/time (time is 0.1 sec)
